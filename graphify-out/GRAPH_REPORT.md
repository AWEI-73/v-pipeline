# Graph Report - video_pipeline  (2026-06-07)

## Corpus Check
- 62 files · ~90,619 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 992 nodes · 1461 edges · 80 communities (49 shown, 31 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 145 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf9828a8`
...
Cohesion: 0.05
Nodes (59): ContentQATest, Return the Python interpreter command for the current platform., resolve_python(), _cmd_init(), _cmd_new_run(), cmd_project_init(), cmd_project_new_run(), create_run_dir() (+51 more)
...
Cohesion: 0.14
Nodes (17): run(), cmd_burnsub(), cmd_concat(), cmd_cut(), cmd_download(), cmd_probe(), cmd_script_run(), cmd_search() (+9 more)
...
Cohesion: 0.27
Nodes (5): test_fresh_run_compiles_video(), test_non_repo_cwd_resolution(), test_rerun_node_12_runs_verification_directly_without_deleting_final(), test_wait_for_generated_provider_arrived_triggers_rebuild(), TestRuntime
...
Cohesion: 0.13
Nodes (6): MatchMontageMultiPickTest, PhotoHandlingTest, MV-cut increment ①: beat → cut_grid (timeline:beat driver).  Pure-function tests, RunMvArtifactTest, ShotMidpointsTest, SrtTsTest
...
Cohesion: 0.2
Nodes (11): _audio_duration(), 用 ffprobe 取得媒體長度(秒)。共用底層原語。, cmd_collage(), cmd_grade(), cmd_kenburns(), cmd_montage(), vt_effects.py — 特效師(色彩分級/字卡/Ken Burns/拼貼/蒙太奇),從 video_tools 解耦。 共用原語取自 vt_core,避, 把照片變成有 Ken Burns 慢推鏡的 1920x1080 影片 (+3 more)

### Community 28 - "Community 28"
Cohesion: 0.2
Nodes (11): Find a CJK font file for ffmpeg drawtext / subtitle burning.      Returns the ab, resolve_font(), video tools 統一錯誤。`fix_class`(material/spec/human)可選,讓 route/dashboard     像 Reco, ToolError, cmd_title_card(), cmd_title_sequence(), 片頭/片尾：產生獨立的動態標題片段（文字滑入→hold→淡出）於深色底 + 暈影。     1920x1080/30fps/bt709。--anim slide, 字卡：在影片開頭疊加標題（淡入→hold→淡出），可選副標。保留規格與時長。 (+3 more)
...
- **Why does `ToolError` connect `Community 28` to `Community 0`, `Community 68`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 17`, `Community 19`, `Community 51`, `Community 20`, `Community 25`, `Community 27`, `Community 29`?**
  _High betweenness centrality (0.185) - this node is a cross-community bridge._
- **Why does `load_dashboard_state()` connect `Community 6` to `Community 1`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `resolve_python()` connect `Community 1` to `Community 10`, `Community 23`?**
