...
<!-- TOOL_CONTRACT_START -->
{
  ...
  "canonical_tools": [
    ...
    },
    {
      ...
      "outputs": ["review video candidate", "rough_cut_execution_report.json"],
      "stop_if": ["rough_cut_plan is unreviewed", "selected source clips are missing", "operator treats the preview as final.mp4"]
    },
    {
