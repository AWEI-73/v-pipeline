...
<!-- TOOL_CONTRACT_START -->
{
  ...
  "canonical_tools": [
    ...
    },
    {
      ...
      "outputs": ["materials_db.source_candidates.json", "material_understanding_matrix.json", "material_wall_review_verdict.draft.json", "material_first_boundary_acceptance_report.json", "rough_cut_plan.json"],
...
and material-first boundary acceptance. It intentionally stops at reviewable
artifacts. The 12 second `rough_cut_plan.json` is a smoke handoff, not the final
edit. Use it to prove the material-first route has enough structure before
expanding into a 60-90 second preview.
