...
修訂已通過 fresh-agent reproducibility；L2–L5 為 doctrine 級**（沿用
`docs/construction-guides/2026-07-10-editing-loop-product-spec.md`）。未認證
模式首次執行時視同 first-of-kind 試航，須加倍申報偏差；L1 的 PASS
不得外推為完整影片或其他 layer 的 creative approval。
