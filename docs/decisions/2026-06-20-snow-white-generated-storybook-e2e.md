...
This is not "大材小用" for the project direction. It may look heavy for a single simple fairy tale, but the point of Hermes is not one-off rendering. The value appears when the same lifecycle supports many routes with predictable gates:
...
- `docs/decisions/2026-06-19-story-soul-blueprint.md`
- `docs/decisions/2026-06-19-storyboard-panel-lock.md`
- `docs/decisions/2026-06-18-material-generation-fallback.md`
- `docs/decisions/2026-06-18-generated-material-producer.md`
