...
| Workbench Draft Review | `dashboard.md`, `brownfield-edit.md` | `preview_timeline.json`, `timeline_patch.json`, `patched_draft_timeline.json`, `workbench_contract_patch.json` | canonical timeline, material map, final render | draft patch is validated | patch changes truth or lacks review | Brownfield or main route review |
...
| Subtitle / Narration Execution | `subtitle-director.md`, `audio-director.md` | `subtitles.srt`, `narration_manifest.json`, TTS/voiceover manifests | route decisions, material truth | required text/audio assets exist and are UTF-8/readable | missing narration audio, unreadable subtitles, language mismatch | Verify / Delivery |
