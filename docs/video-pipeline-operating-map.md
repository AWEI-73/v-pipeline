...
For any rendered rough cut or candidate, the horizontal whole-story evidence
surface is `tools/timeline_review_packet.py`: uniform walls make the complete
...
deterministic QA and its semantic output cannot certify delivery.
