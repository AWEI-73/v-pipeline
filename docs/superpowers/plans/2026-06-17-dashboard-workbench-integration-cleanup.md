...
- Create or update: `docs/decisions/2026-06-17-dashboard-workbench-integration-cleanup.md`
...
- Create: `docs/decisions/2026-06-17-dashboard-workbench-integration-cleanup.md`
...
- [ ] Add links:
  ...
  - `docs/decisions/2026-06-17-dashboard-workbench-integration-cleanup.md`
...
```powershell
git add docs/decisions/2026-06-17-dashboard-workbench-integration-cleanup.md docs/workbench-dashboard-integration.md dashboard/README.md docs/INDEX.md roadmap.md
...
- [ ] Update `docs/decisions/2026-06-17-dashboard-workbench-integration-cleanup.md`:
  - `Status: verified`
...
```powershell
git add docs/decisions/2026-06-17-dashboard-workbench-integration-cleanup.md docs/workbench-dashboard-integration.md
